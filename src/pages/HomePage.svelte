...
{#if !$user}
  ...
  <div id="login-message">
    ...
    <button id="home-page-favorites-login-button" on:click={navigateToLogin}>Log In / Sign Up</button>
  </div>
...
{:else}
  <!-- No favorites yet -->
  <div id="add-favorites-message">You don't have any favorites yet. Start adding movies!</div>
{/if}
